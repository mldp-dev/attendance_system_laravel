              ...
              <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="relative overflow-x-auto  mt-6" style="background-color: #fff; padding: 10px">
                  <h1 class="font-semibold text-xl tracking-tight mr-6 ml-7"
                    style="margin-bottom: 20px; text-align:center">Users</h1>
                  ...
                  <form action="/user" method="POST" id="editUserForm">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="name" aria-describedby="emailHelp"
                        placeholder="Enter name" name="name" value="{{ $user_data->name }}">
                      <br>
                      @error('name')
                    ...
                    <div class="form-group" class="form-label">
                      ...
                      <input type="text" class="form-control" id="email" aria-describedby="emailHelp"
                        placeholder="Enter email" name="email" value=" {{ $user_data->email }}">
                      <br>
                      @error('email')
                      <p class="alert alert-danger">
                        {{ $message}}
                    ...
                    <div class="form-group" class="form-label">
                      ...
                      <input type="password" class="form-control" id="password" aria-describedby="emailHelp"
                        placeholder="Enter password" name="password" value=" {{ $user_data->password }}">
                      <br>
                      @error('password')
                      <p class="alert alert-danger">
                        {{ $message}}
